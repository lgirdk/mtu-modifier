...
static ssize_t mtu_mod_read_proc(struct file *file, char __user *buf, size_t len, loff_t *ppos)
{
	return(0);
}

static ssize_t mtu_mod_write_proc(struct file *file, const char __user *buffer, size_t count, loff_t *data)
{
